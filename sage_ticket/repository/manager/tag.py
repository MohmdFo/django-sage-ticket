...
class TagDataAccessLayer(Manager):
    ...
    def filter_recent_tags(
        ...
        date of their associated tutorials. An optional 'limit' parameter can restrict the
    ...
    def annotate_total_tutorials(self) -> QuerySet:
        """
        Annotate tags with the total number of associated tutorials.
        """
    ...
    def filter_by_tutorials_category(self, category_title) -> QuerySet:
        ...
        """
        return self.get_queryset().filter_by_tutorials_category(category_title)
    ...
    def filter_by_tutorial_date_range(self, start_date, end_date) -> QuerySet:
        ...
        """
        return self.get_queryset().filter_by_tutorial_date_range(start_date, end_date)
